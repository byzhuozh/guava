...
public abstract class RateLimiter {
    ...
    static RateLimiter create(double permitsPerSecond, SleepingStopwatch stopwatch) {
        // maxBurstSeconds 为 1.0，也就是说，最多会缓存 1 秒钟，也就是 (1.0 * permitsPerSecond) 这么多个 permits 到池中
    ...
    // 在这段时间RateLimiter会有个缓冲，直到达到它的最大速率
    ...
    @VisibleForTesting
    static RateLimiter create(double permitsPerSecond,  // 每秒发放许可数量，即所谓的QPS
                              long warmupPeriod,    // 设置预热时间
                              TimeUnit unit,        // warmupPeriod 的时间单位
                              double coldFactor,   // 固定值 3
